  ...
  try {
    ...
    const [
      ...
      usersRef
        ...
        .get(),
      usersRef
        .where("school", "!=", "University of South Florida")
        .where("checkedIn", "==", true)
        .count()
        .get(),
    ]);
    ...
    const data = {
      ...
      totalMale: totalMale.data().count,
      totalFemale: totalFemale.data().count,
      totalOtherSchools: totalOtherSchools.data().count,
    };
